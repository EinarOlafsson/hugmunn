...
localagent could already start a model with no script, by assembling the
...
# {label}
#
# Written by localagent on first launch, because no script existed for this
# model. It is yours now: edit it freely. localagent never overwrites an
