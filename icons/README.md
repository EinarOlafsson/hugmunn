...
The application logo is the [minimal joined-wing design](minimal/README.md):
two outward-looking raven heads and joined wings enclosing an all-seeing eye.
Only a few broad wing shapes remain, with open chests and necks. It refines
the owner's selected **01 — Outward gaze** around those essential features.
...
[Current original PNG](minimal/joined-wings.png) · [Generation prompt](minimal/prompt.txt)

The [first feather reduction](simplified/README.md) is also preserved.
...
[`archive/joined-wings-detailed/`](archive/joined-wings-detailed/), and
